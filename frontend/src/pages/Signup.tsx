...
const SignupForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!name || !studentId || !email || !nationalId || !sex) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className=" flex justify-center items-center mt-16  ">
        {error && (
          <p className="text-red-500 text-center mb-4 font-Peyda font-bold">
            {error}
          </p>
        )}
      </div>
      ...
      <div className="z-20 absolute right-[6.5%] lg:right-[30%]  top-[14%] lg:top-[20%]   w-[87%] lg:w-[40%] p-8 rounded-2xl  backdrop-blur-0 bg-[#ffffff03] border border-white/20 shadow-[inset_0_0_18px_rgba(255,255,255,0.2)] ">
        <h2 className="text-2xl font-semibold mb-6 text-center text-primary-2 font-Potk">
          فرم ثبت نام
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="flex flex-col gap-2">
            <label
              htmlFor="name"
              className="block font-Peyda text-sm font-medium text-primary-1 text-right mr-3"
            >
              {" "}
              : نــام و نــام خانوادگی{" "}
            </label>
            <input
              type="text"
              id="name"
          ...
          <div className="flex flex-col gap-2">
            ...
            />
            <div className="absolute  top-[13.3rem] right-10">
              {" "}
              <LottieIcon animationData={id} width={40} height={40} />
            </div>
          </div>
          ...
          <div className="flex flex-row gap-4 justify-between">
            <div className="flex flex-col w-[50%] lg:w-[40%] gap-2">
              <label
                htmlFor="sex"
                className="block font-Peyda lg:text-sm text-xs font-medium text-primary-1 text-right mr-3"
              >
                {" "}
                : جنسیت{" "}
              </label>
          ...
          <div className="flex flex-col gap-2">
            ...
            />
            <div className="absolute  top-[25.3rem] right-10">
              {" "}
              <LottieIcon animationData={Email} width={40} height={40} />
            </div>
          </div>
